...
link:overview_diagram.png[image:overview_diagram.png[overview_diagram], window=_blank]
...
link:workflow_diagram.png[image:workflow_diagram.png[workflow_diagram], window=_blank]
