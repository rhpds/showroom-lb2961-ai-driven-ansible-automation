...
The goal is to showcase how **automation + AI** can be used to detect, analyze, and remediate an application failures **without writing any playbooks manually**.
...
We will break this up into sections though!  As you go through each module we will break this down to make it easy! Red Hat will make AIOps easy for organizations to adopt and scale 🎉
