...
- 🛑 *HTTPD Error Logs*: These logs were automatically collected from the webserver using Filebeat and streamed via Kafka.
...
image::mattermost_logs_and_rca_placeholder.png[Mattermost logs and RCA message preview]
